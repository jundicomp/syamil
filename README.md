...
- ~~Matriks Harga (harga bertingkat per jumlah/ukuran) belum otomatis~~ ✅ **Selesai penuh (v0.25.0)** — editor tier+bahan (v0.24.0) dan POS sudah lookup otomatis (bahan+sisi+tingkatan qty → harga, v0.25.0).
